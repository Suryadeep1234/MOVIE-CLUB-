...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://subhadeeprampur: subhadeeprampur@subhadeep.hg7u8qy.mongodb.net/subhadeeprampur?retryWrites=true&w=majority&appName=Subhadeep")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "subhadeeprampur") # Database name (default: cluster)
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MC_MOVIES_LTD') # Group link for the bot
