...
PICS = (environ.get('PICS', 'https://graph.org/file/09ded58229ec19fb596cb-ce4e0f7410ac8223ae.jpg')).split()  # Sample pic
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7404203924 6911191278').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002364135159').split()]  # Channel id for auto indexing (make sure bot is admin)

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002580632118'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002694665484'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002641736517'))  # Premium logs channel id
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002636760221').split()] #(make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://RDX:RDX@cluster0.ckt1p.mongodb.net/RDX?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the database
DATABASE_NAME = environ.get('DATABASE_NAME', "RDX") # Database name (default: cluster)
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1003589978897'))  # Notification of sent to your channel
...
TMDB_API_KEY = environ.get('TMDB_API_KEY', '744cb86428114a0aab28286b9687bbfe') # preffer to use your own tmdb API Key get it from https://www.themoviedb.org/settings/api
...
TUTORIAL = environ.get("TUTORIAL", "https://t.me/RDX1444")   # Tutorial link for verification
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/RDX1444")   # Second tutorial link for verification
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/RDX1444")   # Third tutorial link for verification

# Verification (Must Fill All Veriables. Else You Got Error
SHORTENER_API = environ.get("SHORTENER_API", "fa7b06fadcb10ca159f29be425adcbae662469b5") # Shortener API key
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "gplinks.in") # Shortener website

SHORTENER_API2 = environ.get("SHORTENER_API2", "fa7b06fadcb10ca159f29be425adcbae662469b5")  # Shortener API key for second website
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "gplinks.in") # Shortener website for second website

SHORTENER_API3 = environ.get("SHORTENER_API3", "fa7b06fadcb10ca159f29be425adcbae662469b5")  
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", "gplinks.in") # Shortener website for third website
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MC_MOVIES_PVT') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/RDX1444') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/MC_PVT_HD') # Update channel link for the bot
